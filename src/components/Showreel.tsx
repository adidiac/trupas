...
type VideoItem = {
  id: string
  title: string
  // optional start time in seconds, if you want to deep-link
  start?: number
}
...
export default function Showreel() {
  ...
  // Particles (matching the rest of the site)
  useEffect(() => {
    ...
    <section id="media" className="showreel-section">
      ...
      <div className="container">
        ...
        <div className="cta-row">
          ...
          {/* Removed the "Cere ofertă" button as requested */}
        </div>
      </div>
      ...
      <style jsx>{`
        .showreel-section {
          ...
          width: 100vw;
          min-height: 100vh;
          background: #24243e; /* hard-set as requested */
          color: var(--text);
          overflow: hidden;
          display: flex;
          align-items: center;
